...
class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        var color = this.hexToRgbA('#8b5a2b');
        this.wood.setAmbient(color[0], color[1], color[2], 1.0);
        this.wood.setDiffuse(color[0], color[1], color[2], 1.0);
        this.wood.setSpecular(color[0]*0.1, color[1]*0.1, color[2]*0.1, 1.0);
    ...
    updateAmbientLight(){
      this.AmbientLightIntensity, this.AmbientLightIntensity, this.AmbientLightIntensity, 0.1;
    }
    ...
    display() {
        ...
        this.setGlobalAmbientLight(this.AmbientLightIntensity, this.AmbientLightIntensity, this.AmbientLightIntensity, 0.1);
